...
//  HelloWorld
//
//  Created by Jennifer Huang on 9/1/14.
    ...
    class func albumsWithJSON(allResults: NSArray) -> [Album] {
        ...
        if allResults.count>0 {
            ...
            for result in allResults {
                ...
                // sometimes price comes as formattedPrice, sometimes as collectionPrice and sometimes  it's a float instead of a string
                var price = result["formattedPrice"] as? String
                if price == nil {
                    price = result["collectPrice"] as? String
                    if price == nil {
